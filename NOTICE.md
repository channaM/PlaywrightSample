...
- **License**: MIT
- **Repository**: https://github.com/deepakkamboj/playwright-ms-auth
- Used for Microsoft authentication state management in Playwright tests.
...
- Copyright (c) 2015 Sebastian Lenz, TypeStrong
...
This file is provided for informational purposes. Please refer to each project's repository
